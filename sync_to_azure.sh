...
read -s -p "🔑 Enter your Azure Password: " MYPASS
echo ""

# Function to run remote commands via sshpass
run_remote() {
    sshpass -p "$MYPASS" ssh -o StrictHostKeyChecking=no $REMOTE_USER@$REMOTE_HOST "$1"
}
