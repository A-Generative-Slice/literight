  ...
  return (
    <nav style={{ 
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 40 }}>
        <div className="md-hidden" style={{ display: 'flex', gap: 32, fontSize: 13, fontWeight: 800, letterSpacing: '0.1em' }}>
          <span className="hover-lift" style={{ cursor: 'pointer' }}>PROJECTS</span>
          <span className="hover-lift" style={{ cursor: 'pointer' }}>OUR CLIENTS</span>
          <span className="hover-lift" style={{ cursor: 'pointer' }}>CONTACT US</span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          {user ? (
            ...
            <button 
              ...
              style={{ background: '#fff', color: '#000', border: 'none', padding: '8px 24px', borderRadius: 99, fontSize: 11, fontWeight: 900, cursor: 'pointer' }}
            >
              LOGIN
            </button>
          )}
        ...
        <div style={{ position: 'fixed', inset: 0, background: '#000', zIndex: 1100, padding: '60px var(--container-px)', animation: 'reveal 0.3s forwards' }}>
          ...
          <div style={{ maxWidth: 800, margin: '60px auto' }}>
            <input 
              autoFocus
              placeholder="SEARCH..." 
              style={{ width: '100%', background: 'none', border: 'none', borderBottom: '2px solid #fff', padding: '20px 0', fontSize: 32, color: '#fff', fontWeight: 900, outline: 'none' }}
            />
          </div>
        </div>
      )}
